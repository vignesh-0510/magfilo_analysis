...
const FilterChirality = () => {
	const [isFormSubmitted, setIsFormSubmitted] = useState(false);
	const [isInitialLoad, setIsInitialLoad] = useState(true);
	const inputGeometryRef = useRef();
	const [inputGeometry, setInputGeometry] = useState(null);
	const inputChiralityRef = useRef();
	const [inputChirality, setInputChirality] = useState(null);
	const handleFormSubmit = (e) => {
		e.preventDefault();
		setInputGeometry(inputGeometryRef.current.value);
		setInputChirality(inputChiralityRef.current.value);
						...
						>
							...
							<div className={`${classes["form-row"]} col-auto`}>
								<select
									...
									name="chirality_type"
									id="chirality_type"
									ref={inputChiralityRef}
								>
									<option value="Left">Left</option>
									<option value="Right" selected>
										Right
									</option>
									<option value="Unidentifiable">
										Unidentifiable
									</option>
...
export default FilterChirality;
